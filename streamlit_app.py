...
if st.sidebar.button("🏠 Job Seeker", use_container_width=True, key="main_btn"):
    st.session_state.current_page = "main"
if st.sidebar.button("💼 Job Search & Insights", use_container_width=True, key="job_matching_btn"):
...
- **Job Search & Insights**: Find AI-matched positions and view market reports
